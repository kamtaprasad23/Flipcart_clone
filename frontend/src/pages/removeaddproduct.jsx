...
const Removecart = () => {
  ...
  return (
    <div
      className={`fixed top-0 right-0 h-screen w-[368px] p-5 bg-white border-l border-gray-300 transition-transform duration-700 ease-in-out z-40 ${
        ...
        <div className="grid grid-cols-1 gap-4">
          {addtocart.map((e) => (
            <div key={e.cartId} className="bg-white p-4 rounded-xl shadow-md flex flex-col items-center">
              <img src={e.image} alt={e.name} className="w-fit h-36 object-cover rounded-md mb-2" />
